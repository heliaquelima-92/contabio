...
function ModalDefinirValor({ aberto, onFechar, conta, onSalvar }) {
  ...
  // Buscar observações da conta original
        ...
        {observacoes && (
          <div>
            <button 
              ...
              className="w-full text-left p-3 bg-moncash-lime/10 border border-moncash-lime/30 rounded-xl flex items-center justify-between"
            >
              <span className="text-sm text-moncash-lime flex items-center gap-2">
                📝 Ver Observações
              </span>
              <span className="text-moncash-lime">{mostrarObs ? '▲' : '▼'}</span>
            </button>
            {mostrarObs && (
              <div className="mt-2 p-4 bg-moncash-darker rounded-xl border border-moncash-border">
