...
export function DadosProvider({ children }) {
  ...
  const gerarContasMes = async () => {
    ...
    // Contas fixas - apenas as ATIVAS (ativa !== false)
    for (const fixa of contasFixas) {
      if (fixa.ativa !== false) { // Se não tem campo ou é true, está ativa
        novasContas.push({
    ...
    // Parceladas - apenas as que têm parcelas restantes e não estão arquivadas
    ...
    // Cartões - apenas os ATIVOS (ativa !== false)
